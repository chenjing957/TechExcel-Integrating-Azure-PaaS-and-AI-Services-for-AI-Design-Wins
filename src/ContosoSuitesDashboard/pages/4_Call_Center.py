...
def generate_extractive_summary(call_contents):
    ...
    return json.loads('{"call-summary":"' + extractive_summary + '"}') #"This is a placeholder result. Fill in with real extractive summary."
...
def generate_abstractive_summary(call_contents):
    ...
    return json.loads('{"call-summary":"' + abstractive_summary + '"}') #"This is a placeholder result. Fill in with real abstractive summary."
...
def generate_query_based_summary(call_contents):
    ...
    return response.choices[0].message.content #"This is a placeholder result. Fill in with real query-based summary."
